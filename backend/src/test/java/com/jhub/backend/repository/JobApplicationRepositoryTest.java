...
class JobApplicationRepositoryTest {
  ...
  void findByUserIdAndStatus_filtersCorrectly() {
    List<JobApplication> results =
        jobApplicationRepository.findByUserIdAndStatus(user1.getId(), JobApplicationStatus.APPLIED);
  ...
  void findByUserIdAndStatus_returnsEmptyForNoMatches() {
    List<JobApplication> results =
        jobApplicationRepository.findByUserIdAndStatus(user1.getId(), JobApplicationStatus.OFFER);
  ...
  void existsByIdAndUserId_returnsFalseForNonExistentApp() {
    assertThat(jobApplicationRepository.existsByIdAndUserId(UUID.randomUUID(), user1.getId()))
        .isFalse();
  }
}
